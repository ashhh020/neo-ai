...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: "var(--silica-bg)" }}>
      <div style={{ width: 500, height: 500, background: "radial-gradient(circle, rgba(78,115,223,0.15) 0%, transparent 70%)", top: "10%", left: "20%", position: "fixed", borderRadius: "50%", filter: "blur(60px)", pointerEvents: "none" }} />
      <div style={{ width: 400, height: 400, background: "radial-gradient(circle, rgba(138,43,226,0.1) 0%, transparent 70%)", bottom: "15%", right: "15%", position: "fixed", borderRadius: "50%", filter: "blur(60px)", pointerEvents: "none" }} />
      ...
      <div className="shard w-full max-w-md p-8 relative z-10">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-[10px] font-mono-neo uppercase tracking-widest" style={{ color: "var(--text-dim)" }}>Student Platform</p>
          </div>
        </div>
        ...
        <p className="text-center text-sm mt-5" style={{ color: "var(--text-dim)" }}>
          ...
          <Link href="/register" className="font-semibold" style={{ color: "var(--accent-mineral)" }}>Create one</Link>
        </p>
      </div>
    </div>
  );
