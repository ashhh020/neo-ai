...
const navItems = [
  { href: "/doctor", label: "Clinic OS", icon: LayoutDashboard },
  { href: "/doctor/patients", label: "Patients", icon: Users },
  { href: "/doctor/prescriptions", label: "Prescriptions", icon: Stethoscope },
    ...
    <aside className="w-60 flex-shrink-0 h-full border-r bg-card flex flex-col">
      <div className="h-14 border-b flex items-center px-5 gap-2.5">
        ...
        <div>
          ...
          <div className="text-[10px] text-muted-foreground">Clinic OS</div>
        </div>
      </div>
